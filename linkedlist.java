...
public class linkedlist {
    ...
    // for delete first and last we should make head at 2nd part since after that first part is deleted forever 
    // if i want to go for last then we should select second last so that last is cut forever
